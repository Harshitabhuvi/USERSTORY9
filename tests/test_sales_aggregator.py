...
class SalesAggregationTests(unittest.TestCase):
    ...
    def test_multiple_sales_aggregation(self):
        ...
        sales = [
            ...
            {"product_id": "1", "transaction_date": "2024-04-11", "quantity_sold": "3"},
        ]
    ...
    def test_invalid_transaction_date(self):
        ...
        sales = [
            {"product_id": "1", "transaction_date": "wrong-date", "quantity_sold": "5"}
        ]
    ...
    def test_outside_month_ignored(self):

        inventory = {"1": {}}

        sales = [
            {"product_id": "1", "transaction_date": "2024-03-10", "quantity_sold": "5"}
        ]
    ...
    def test_valid_transaction_count(self):
        ...
        sales = [
            {"product_id": "1", "transaction_date": "2024-04-10", "quantity_sold": "2"}
        ]

        result, processed, quality = aggregate_sales(sales, inventory)

        self.assertEqual(quality["valid_transactions"], 1)
